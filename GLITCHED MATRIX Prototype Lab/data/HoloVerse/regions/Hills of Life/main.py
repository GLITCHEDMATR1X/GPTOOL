#!/usr/bin/env python3
"""Hills of Life dimension entry.

This folder owns the active runtime for Hills of Life. HoloVerse mounts
`runtime.py` inside the live GREEN HILLS region through the shared in-world
...
DIMENSION_ID = 'hills_of_life'
DIMENSION_NAME = 'Hills of Life'
BOT_OWNER = 'Nyx'
REGION_OWNER = 'GREEN HILLS'
