#!/usr/bin/env python3
"""HoloForge dimension entry.

This folder owns the active runtime for HoloForge. HoloVerse mounts
`runtime.py` inside the live FLAT region through the shared in-world
...
DIMENSION_ID = 'holoforge'
DIMENSION_NAME = 'HoloForge'
BOT_OWNER = 'IO'
REGION_OWNER = 'FLAT'
