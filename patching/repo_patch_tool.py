#!/usr/bin/env python3
"""GPTOOL repo-safe patch-only zip dry-run/apply helper.

Version: GPTOOL Pass 17 AI Patch Gate repo-apply companion.
...
try:
    ...
    try:
        ...
        raise SystemExit(f"Could not import pass_combiner.py helpers: {exc}")
...
def _friendly_no_args() -> int:
    print("")
    print("Repo Patch Tool needs repo and patch paths. Double-clicking the .py file alone cannot know where your GX repo or patch zip is.")
    print("")
    print("Use one of these instead:")
    print("  START_HERE.bat")
    print("  START_HERE_REPO_PATCH.bat")
    print("  DRY_RUN_HOLOCORE_PATCH_TO_GX_REPO.bat")
    print("")
